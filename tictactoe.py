...
opening = pg.image.load('tic_tac_opening.jfif')
...
# blit() function is used to draw an image on top of another image

def game_opening():
    screen.blit(opening,(0,0))
    pg.display.update() #So after we draw the opening image and after drawing, we always need to update the display with pg.display.update().
    time.sleep(1)
    screen.fill(white)
